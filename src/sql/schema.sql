CREATE TABLE player (
  ...
  player_nb_wins INTEGER UNSIGNED ZEROFILL NULL,
  player_nb_losses INTEGER UNSIGNED ZEROFILL NULL,
...
CREATE TABLE game (
  ...
  game_ia_white_player INTEGER UNSIGNED NOT NULL,
  game_ia_black_player INTEGER UNSIGNED NOT NULL,
